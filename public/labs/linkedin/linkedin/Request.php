...
class LinkedIn_Request
{
	...
	{
		$xml = '<?xml version="1.0" encoding="UTF-8"?><current-status>'.$this->getStatus().'</current-status>';
		return $xml;			
	}
	...
	{
		$this->_oauth->fetch(BASE_API_URL.'/v1/people/~/network');
		$network = $this->_oauth->getLastResponse();
		return $network;
	}
